...
export const COMPACT = "0x0000000000FFe8B47B3e2130213B802212439497" as const;
...
export const INPUT_SETTLER_ESCROW_LIFI =
	"0x00000000047f00705d0977cD8A992df87a35D494" as const;
...
export function getCoin(
	args: { name: string; chain: chain; address?: undefined } | {
		address: `0x${string}`;
		chain: chain;
		name?: undefined;
	},
	...
	const concatedAddress = "0x" + address?.replace("0x", "")?.slice(
		address.length - 42,
		address.length,
	);
