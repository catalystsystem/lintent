...
export const CATALYST_SETTLER = '0x000000006B10B0C15dC80dCE37d52aC76dA81000' as const;
export const ALWAYS_OK_ALLOCATOR = '202111693189738293457932475' as const;
export const POLYMER_ALLOCATOR = '42660788311074554149149136' as const; // 0xa8F98ADEC52C7FE5792349c5F7e52AC6490919D0 signing by 0x934244C8cd6BeBDBd0696A659D77C9BDfE86Efe6
export const COIN_FILLER = '0x000000EAFFB4470c0000902609d94d0e557AcEB7' as const;
...
export const POLYMER_ORACLE = {
	sepolia: '0x000000DFBB00Bc799dB942b1217d86EB00337f86.',
	baseSepolia: '0x000000DFBB00Bc799dB942b1217d86EB00337f86.',
	arbitrumSepolia: '0x000000DFBB00Bc799dB942b1217d86EB00337f86.',
	optimismSepolia: '0x000000DFBB00Bc799dB942b1217d86EB00337f86.'
} as const;
