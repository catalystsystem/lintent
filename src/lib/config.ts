...
export const INPUT_SETTLER_COMPACT_LIFI =
	"0x000000c9eC71B1a39055Ec631200ED0022140074" as const;
export const INPUT_SETTLER_ESCROW_LIFI =
	"0x000001bf3F3175BD007f3889b50000c7006E72c0" as const;
...
export const COIN_FILLER =
	"0x00000000D7278408CE7a490015577c41e57143a5" as const;
...
export type availableAllocators =
	| typeof ALWAYS_OK_ALLOCATOR
	| typeof POLYMER_ALLOCATOR;
...
export type balanceQuery = Record<
	chain,
	Record<`0x${string}`, Promise<bigint>>
>;
...
export const chainMap = { ethereum, base, arbitrum, sepolia, optimismSepolia, baseSepolia } as const;
...
export function getCoin(
	...
	const concatedAddress = "0x" +
		address?.replace("0x", "")?.slice(address.length - 42, address.length);
